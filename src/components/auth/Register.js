...
<<<<<<< HEAD
        const res  = await axios.post("http://0f13e9d9366d.ngrok.io/signup",registerData,config)
=======
        const res  = await axios.post("http://e9af1ac45e0a.ngrok.io/signup/",registerData,config)
